...
format:
  revealjs:
    ...
    center: true
    css: custom.css
    footer: "https://jeffreyracine.github.io/CESG2023 | J. Racine"
...
2.  Bandwidth choice ("fixed") is ISE/IMSE optimal (i.e., "global" rather than "pointwise" - is this wise? time for a rethink?)

3.  Is a fixed bandwidth the best in this setting? What about "locally adaptive" bandwidths?

4.  Perhaps the following might be an alternative to the existing simulations
