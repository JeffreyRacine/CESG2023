...
- Link to slides - <a href="https://jeffreyracine.github.io/CESG2023">jeffreyracine.github.io/CESG2023</a> (case sensitive, <a href="https://jeffreyracine-github-io.translate.goog/CESG2023/?_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=wapp#/title-slide">Translate</a>)
...
- Link to slides - <a href="https://jeffreyracine.github.io/CESG2023">jeffreyracine.github.io/CESG2023</a> (case sensitive, <a href="https://jeffreyracine-github-io.translate.goog/CESG2023/?_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=wapp#/title-slide">Google Translate</a>)
...
-   This can be attained when using, e.g., cross-validation to select the bandwidth *and* polynomial order when using *continuous* kernel functions [@HALL_RACINE:2015]
...
-   Otherwise, when kernel smoothing with the Nadaraya-Watson estimator under common regularity conditions, we attain a $\sqrt{nh}$ rate of convergence
...
-   Bandwidth choice ("fixed") is ISE/IMSE optimal (i.e., "global" rather than "pointwise")

-   Is a fixed bandwidth the best in this setting?

-   What about "locally adaptive" bandwidths?

-   The simulations are extensive but might be improved

-   I am not sure I learn anything about *rates* from the simulations
